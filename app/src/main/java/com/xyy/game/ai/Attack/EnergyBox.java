 ...
 */
public class EnergyBox extends Attack {
    private float timer;
    ...
    public void present(Graphics g, float offsetX, float offsetY) {
        ...
        g.drawPixmapScale(Assets.energy,x - offsetX, y - offsetY, scaX,scaY,(int)alpha);
    }
